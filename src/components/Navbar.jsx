...
const NavBar = () => {
    ...
    // login thakle coockie te seesion add hoi, seta show hobe.
    ...
    return (
        <nav className="flex items-center justify-between bg-[#393E46] px-4 py-2 text-white">
            ...
            <div>
                {
                    session.status === 'authenticated' ? <li onClick={() => signOut()} className="cursor-pointer flex gap-2 list-none rounded-full px-6 py-2 text-white hover:bg-sky-600">
